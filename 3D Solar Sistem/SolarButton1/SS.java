...
public class SS extends MouseAdapter {	
...
public SS(){	 
    ...
    video.setVisible(true);
        ...
        Logger.getLogger(SolarSis.class.getName()).log(Level.SEVERE,null,ex);
    }*/
    ...
    TransformGroup merRotXGroupX = Posi.rotate(merTransX, new Alpha(-1, 20000));
    group.addChild(merRotXGroupX);//mercurio rotando y trasladando
    TransformGroup venuRotXGroupX=Posi.rotate(venuTransX, new Alpha(-1, 20000));
    group.addChild(venuRotXGroupX);

    TransformGroup earthRotGroupX = Posi.rotate(earthTransX, new Alpha(-1, 20000));
    ...
    TransformGroup marteRotGroupX = Posi.rotate(marteTransX, new Alpha(-1, 20000));
    group.addChild(marteRotGroupX);//marte rotando y transaldando
    TransformGroup jupiRotGroupX = Posi.rotate(jupiTransX, new Alpha(-1, 20000));
    group.addChild(jupiRotGroupX);

    TransformGroup satRotGroupX = Posi.rotate(satTransX, new Alpha(-1, 20000));
    group.addChild(satRotGroupX);
    TransformGroup anilloRotGroupX = Posi.rotate(anilloRotX, new Alpha(-1, 2000));
    satTransX.addChild(anilloRotGroupX);

    TransformGroup uranRotGroupX = Posi.rotate(uranTransX, new Alpha(-1, 20000));
    group.addChild(uranRotGroupX);    
    TransformGroup nepRotGroupX = Posi.rotate(nepTransX, new Alpha(-1, 20000));
    group.addChild(nepRotGroupX);
    TransformGroup pluRotGroupX = Posi.rotate(pluTransX, new Alpha(-1, 20000));
    ...
    //************************CONFIGURACION GRAFICA*************************************************
    	...
    	f.add("Soth", jp1);//agregamos el panel al frame
...
public static void main(String a[]) { new SS();}
...
public void mouseClicked(MouseEvent e){
    ...
    if (result == null) {
       ...
       if (p != null) {
            ...
            viewVector = new Vector3f(.0f,.0f, .65f);//para mover la camara sbre el eje z
